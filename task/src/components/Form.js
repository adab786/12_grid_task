...
const Form = () => {
  ...
  const haldkesubmit = () => {
    return alert("submittded");
  };
  return (
    <div className="m-5 flex ">
      <div className="text-3xl">
        Drop us a message, and we’ll
        <br /> get back to you in no time.
      </div>
      ...
      <form class="max-w-md mx-auto">
        ...
        <div class="grid md:grid-cols-2 md:gap-6">
          ...
          <div class="relative z-0 w-full mb-5 group">
            ...
            <ReCAPTCHA
              className="p-2 m-2 relative right-52"
              style={{ width: 20 }}
              sitekey="6LdaPfcpAAAAABN2LrCrVHcrmLnqnotAjwO4hMJN"
              onChange={(val) => setvalue(val)}
            ></ReCAPTCHA>
          </div>
        </div>
        <button
          onClick={haldkesubmit}
          disabled={!value}
          type="submit"
